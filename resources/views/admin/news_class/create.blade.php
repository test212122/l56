            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        {!! Form::open(['url'=>'/admin/news_class/create',"class"=>"form-horizontal"]) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    {{Form::text('sort',99,["placeholder"=>"必填","class"=>"form-control","id"=>"input002"])}}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <div class="checkbox checkbox-success checkbox-inline">
                                        <input name="status[]" type="checkbox" id="inlineCheckbox12" value="1">
                                        <label for="inlineCheckbox12"> 首页 </label>
                                    </div>
                                    <div class="checkbox checkbox-success checkbox-inline">
                                        <input name="status[]" type="checkbox" id="inlineCheckbox2" value="2">
