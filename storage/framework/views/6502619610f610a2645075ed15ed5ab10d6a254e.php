            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <?php echo Form::model($data,['url'=>'/admin/admin/edit',"class"=>"form-horizontal"]); ?>
                                ...
                                <div class="col-sm-8">
                                    <select name="group_id" class="selectpicker" data-style="btn-success">
                                        <?php $__currentLoopData = \App\Model\AdminGroup::where('is_enable',true)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e($data->group_id==$val->id?'checked':''); ?> value="<?php echo e($val->id); ?>"><?php echo e($val->title); ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <?php echo e(Form::input('text','user_name',null,["id"=>"input002","class"=>"form-control","placeholder"=>"必填"])); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <?php echo e(Form::input('password','password',null,["id"=>"input002","class"=>"form-control","placeholder"=>"必填"])); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <?php echo e(Form::input('text','mobile',null,["id"=>"input002","class"=>"form-control","placeholder"=>"必填"])); ?>
