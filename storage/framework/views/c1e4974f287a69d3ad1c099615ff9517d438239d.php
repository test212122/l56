            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php echo Form::model($data,['url'=>'/admin/admin_group/edit',"class"=>"form-horizontal"]); ?>
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="home11">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="is_enable" type="checkbox" <?php echo e($data->is_enable?'checked':''); ?> data-toggle="toggle" data-onstyle="success">
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                <th class="text-nowrap" scope="row">
                                                    <div class="checkbox checkbox-primary">
                                                        <input name="group_id[]" <?php echo e(in_array($val->id,$menu_id)?'checked':''); ?> id="checkbox<?php echo e($val->id); ?>" type="checkbox" value="<?php echo e($val->id); ?>">
                                                ...
                                                <td colspan="4">
                                                    <?php $__currentLoopData = $val->child; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="checkbox checkbox-primary">
                                                            <input name="group_id[]" <?php echo e(in_array($v->id,$menu_id)?'checked':''); ?> id="checkbox<?php echo e($v->id); ?>" type="checkbox" value="<?php echo e($v->id); ?>">
                                                            ...
                                                            <?php $__currentLoopData = $v->child; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $va): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="checkbox checkbox-success checkbox-inline" style="margin-top: -10px;">
                                                                    <input name="group_id[]" <?php echo e(in_array($va->id,$menu_id)?'checked':''); ?> type="checkbox" id="inlineCheckbox<?php echo e($va->id); ?>" value="<?php echo e($va->id); ?>" >
