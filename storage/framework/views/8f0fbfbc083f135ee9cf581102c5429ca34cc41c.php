                ...
                <div class="panel panel-transparent">
                    ...
                    <div class="panel-body">
                        ...
                        <div role="tabpanel">
                            ...
                            <!-- Tab panes -->
                            <?php echo Form::open(['url'=>'/admin/config/edit',"class"=>"form-horizontal"]); ?>
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="home11">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input name="name" type="text" value="<?php echo e(\App\Model\Config::read('name')); ?>" placeholder="必填" class="form-control" id="input002">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input002" class="col-sm-2 control-label form-label">联系电话</label>
                                        <div class="col-sm-5">
                                            <input name="mobile" type="text" value="<?php echo e(\App\Model\Config::read('mobile')); ?>" placeholder="必填" class="form-control" id="input002">
                                        </div>
                                    </div>
                                </div>
